...
?>
	...
	<div class="bpress-wrap">
		...
		<div class="bpress-page-header">
			...
			<header>
				<h1><?php echo esc_html( apply_filters( 'basepress_modern_theme_header_title', 'Knowledge Base' ) ); ?><br><?php echo ( esc_html( $bpkb_is_single_kb ) ? '' : esc_html( $bpkb_knowledge_base->name ) ); ?></h1>
			</header>
